...
const selfDestruct: UnitDataAction = {
  ...
  effects: [{ type: "removeSelf", refund: true }],
};
  ...
  foxToken: {
    ...
    actions: [{
      ...
      effects: [{
        type: "spawn",
        prefab: "fox",
        placement: { kind: "selfOffset", distance: 1.125 },
        lifetime: 150,
        inheritColor: true,
      }],
    }],
  ...
  strengthPotion: {
    ...
    actions: [{
      ...
      effects: [{
        ...
        buff: {
          name: "Strength Potion",
          description: "20x damage on next attack",
  ...
  speedPot: {
    ...
    actions: [{
      ...
      effects: [{
        ...
        buff: {
          name: "Speed Potion",
          description: "+15% movement & +10% attack speed",
      ...
      effects: [
        { type: "restoreMana", amount: 100 },
        {
          ...
          buff: {
            remainingDuration: 1,
            model: "sparkle",
            particleColor: "#34a5e9",
            particleRate: 10,
            particleLifetime: 0.5,
            particleOffsetRange: 0.5,
            particleScaleRange: 0.5,
            modelScale: 0.75,
          },
        },
