export const sounds: Record<string, string> = {
  ...
  error1: new URL("/assets/error1.mp3", import.meta.url).pathname,
  explosion1: new URL("/assets/explosion1.mp3", import.meta.url).pathname,
  growl1: new URL("/assets/growl1.mp3", import.meta.url).pathname,
  growl2: new URL("/assets/growl2.mp3", import.meta.url).pathname,
  growl3: new URL("/assets/growl3.mp3", import.meta.url).pathname,
  growl4: new URL("/assets/growl4.mp3", import.meta.url).pathname,
  ...
  spirit1: new URL("/assets/spirit1.mp3", import.meta.url).pathname,
  spirit2: new URL("/assets/spirit2.mp3", import.meta.url).pathname,
  spirit3: new URL("/assets/spirit3.mp3", import.meta.url).pathname,
